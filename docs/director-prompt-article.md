...
**ANTI-EMPTY RULE (КРИТИЧНО)**: каждый слайд должен нести фактическую информацию. Запрещено:
- bullet_list с менее чем 3 заполненными буллетами
- любой слайд где основные поля (заголовок/факт/буллеты) — короткие односложные ответы без сути
- "пустые" слайды с одним заголовком и больше ничем

Если контент кончается на N-1 слайде — **уменьшай TOTAL** до ближайшего чётного числа (8→6→4), НЕ дотягивай пустоту.
